...
@WebServlet("/myTeamDelete")
public class MyTeamDeleteServlet extends HttpServlet {
    private UserHasTeamsService userHasTeamsService;
    private UserService userService;

    public MyTeamDeleteServlet() {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        userHasTeamsService.deleteUserTeam(userService.findUserByUsername
